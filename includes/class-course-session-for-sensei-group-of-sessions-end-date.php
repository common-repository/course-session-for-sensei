<?php
/**
 * Course Session For Sensei Group of Sessions' End_Date
...
/**
 * Course Session For Sensei Group of Sessions' End_Date class
 */
class Course_Session_For_Sensei_Group_Of_Sessions_End_Date extends CSS_WP_Term_Meta_UI {

	/**
	 * @var string Metadata key
	 */
	public $meta_key = 'end_date';
	...
	public function __construct( $file = '' ) {
		...
		// Setup the labels.
		$this->labels = array(
			'singular'    => esc_html__( 'End Date',  'course-session-for-sensei' ),
			'plural'      => esc_html__( 'End Date', 'course-session-for-sensei' ),
			'description' => esc_html__(
				'Select the date this group of sessions ends on.',
