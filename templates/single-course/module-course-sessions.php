 ...
 *
 * Override this template by copying it to yourtheme/course-session-for-sensei/single-course/module-course-sessions.php
 *
 * @author   Open-DSI
...
while ( css_the_group_have_sessions() &&
	...
	<article class="course-session">
		...
		?>
	</article><!-- .course-session -->

<?php endwhile; // css_the_course_has_sessions.
